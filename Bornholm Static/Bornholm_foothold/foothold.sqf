/*
	"Operation Foothold" static mission for Bornholm.
...
_AICount = (15 + (round (random 10)));					//AI starting numbers
_AIMaxReinforcements = (50 + (round (random 30)));		//AI reinforcement cap
...
_AIMaxReinforcements = (60 + (round (random 30)));
...
_AICount = (25 + (round (random 7)));
_AIMaxReinforcements = (70 + (round (random 30)));
_AItrigger = (10 + (round (random 10)));
...
_AIMaxReinforcements = (80 + (round (random 25)));
